...
(function () {
  ...
  function build() {
    ...
    css.textContent = ''
      + '.skym-btn{position:fixed;right:16px;bottom:calc(env(safe-area-inset-bottom) + 18px);'
      + 'width:54px;height:54px;border-radius:50%;background:#6E5FB5;border:none;cursor:pointer;'
      + 'box-shadow:0 6px 20px rgba(110,95,181,.42);z-index:8000;'
